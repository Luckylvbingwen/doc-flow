...
/** 产品线管理员已存在 (409) */
export const PRODUCT_LINE_ADMIN_EXISTS = 'PRODUCT_LINE_ADMIN_EXISTS'
...
// ─── 归属人转移 ───
/** 转移请求不存在 (404) */
export const OWNERSHIP_TRANSFER_NOT_FOUND = 'OWNERSHIP_TRANSFER_NOT_FOUND'
/** 该文档已有待处理的转移请求 (409) */
export const OWNERSHIP_TRANSFER_PENDING_EXISTS = 'OWNERSHIP_TRANSFER_PENDING_EXISTS'
/** 仅归属人可发起转移 (403) */
export const OWNERSHIP_TRANSFER_NOT_OWNER = 'OWNERSHIP_TRANSFER_NOT_OWNER'
/** 不能转移给自己 (400) */
export const OWNERSHIP_TRANSFER_SELF = 'OWNERSHIP_TRANSFER_SELF'
/** 仅目标接收人可处理转移请求 (403) */
export const OWNERSHIP_TRANSFER_NOT_RECIPIENT = 'OWNERSHIP_TRANSFER_NOT_RECIPIENT'
/** 请求不处于待处理状态 (409) */
export const OWNERSHIP_TRANSFER_NOT_PENDING = 'OWNERSHIP_TRANSFER_NOT_PENDING'
/** 待处理转移期间不允许删除文档 (409) */
export const OWNERSHIP_TRANSFER_DELETE_FORBIDDEN = 'OWNERSHIP_TRANSFER_DELETE_FORBIDDEN'

// ─── 权限申请 ───
/** 权限申请不存在 (404) */
export const PERMISSION_REQUEST_NOT_FOUND = 'PERMISSION_REQUEST_NOT_FOUND'
/** 已有待处理的相同类型申请 (409) */
export const PERMISSION_REQUEST_PENDING_EXISTS = 'PERMISSION_REQUEST_PENDING_EXISTS'
/** 仅文档归属人可处理申请 (403) */
export const PERMISSION_REQUEST_NOT_OWNER = 'PERMISSION_REQUEST_NOT_OWNER'
/** 申请不处于待处理状态 (409) */
export const PERMISSION_REQUEST_NOT_PENDING = 'PERMISSION_REQUEST_NOT_PENDING'
/** 申请人已拥有目标权限，无需申请 (400) */
export const PERMISSION_REQUEST_ALREADY_HAS = 'PERMISSION_REQUEST_ALREADY_HAS'

// ─── 文档引用 ───
/** 引用关系不存在 (404) */
export const REFERENCE_NOT_FOUND = 'REFERENCE_NOT_FOUND'
/** 该文档在本组中已存在引用关系 (409) */
export const REFERENCE_ALREADY_EXISTS = 'REFERENCE_ALREADY_EXISTS'
/** 不能引用本组的文档 (400) */
export const REFERENCE_SELF_GROUP = 'REFERENCE_SELF_GROUP'
/** 只有已发布文档可以被引用 (400) */
export const REFERENCE_NOT_PUBLISHED = 'REFERENCE_NOT_PUBLISHED'
/** 批注已冻结，旧版本批注不可编辑/删除 (409) */
export const ANNOTATION_FROZEN = 'ANNOTATION_FROZEN'
