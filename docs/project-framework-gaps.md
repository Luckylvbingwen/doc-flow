...
| 2-1 | P2 | i18n 接线 | — | ⬜ 待做 |
| 2-2 | P2 | 组件级错误边界 | `NuxtErrorBoundary` | ⬜ 待做 |
| 2-3 | P2 | XSS 清洗 | `DOMPurify` | ⬜ 待做 |
| 2-4 | P2 | SEO 基础 | `useHead` / `useSeoMeta` | ⬜ 待做 |
| 2-5 | P2 | 健康检查深度 | DB + Redis ping | ⬜ 待做 |
| 2-6 | P2 | 请求重试与离线兜底 | 指数退避 retry | ⬜ 待做 |
| 2-7 | P2 | Bundle 分析 | `rollup-plugin-visualizer` | ⬜ 待做 |
| 2-8 | P2 | 独立 404 页 | `pages/[...slug].vue` | ⬜ 待做 |
| 2-9 | P2 | 暗黑模式 FOUC 修复 | `useHead` inline script | ⬜ 待做 |
| 2-10 | P2 | 缓存策略 | Redis + `defineCachedEventHandler` | ⬜ 待做 |
